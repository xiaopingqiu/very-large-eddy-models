...
tmp<volSymmTensorField> VLESrealizableKE::R() const
{
...
tmp<volSymmTensorField> VLESrealizableKE::devReff() const
{
    return tmp<volSymmTensorField>
    (
        new volSymmTensorField
...
tmp<fvVectorMatrix> VLESrealizableKE::divDevReff(volVectorField& U) const
{
    return
    (
...
tmp<fvVectorMatrix> VLESrealizableKE::divDevRhoReff
(
